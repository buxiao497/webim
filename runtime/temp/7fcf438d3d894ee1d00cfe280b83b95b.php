<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"/data/wwwroot/thinkSwoole/public/../application/chat/view/index.html";i:1509882137;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
function onOpen(evt) {
  ...
  websocket.send('{"type":"1","uid":"2","content":"登录"}')
} 
function onClose(evt) { 
  console.log("Disconnected"); 
  websocket.send('{"type":"2","uid":"2","content":"登出"}')
}
